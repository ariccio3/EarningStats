...
const Footer = () =>
  <footer className="footer">
    <span className="footerText"><b>EarningStats 2003-2019&emsp;|&emsp;Contact: &nbsp;
    ...
    <div className="resourceText">
        ...
        <p><a href="https://app.powerbi.com/view?r=eyJrIjoiYTVkOWQxOWQtMDI3YS00NmUwLWI1YjktNTJlMTI3MzY2NjlmIiwidCI6ImIwMGE1ZDU0LTI3MzAtNDA2OC04MGIwLTgxNTMwYjhhNDkwZiIsImMiOjJ9">NEW! EarningStats Dashboard</a></p>
    </div>
  </footer>;
