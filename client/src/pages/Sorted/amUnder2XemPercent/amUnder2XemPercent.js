...
import "./amUnder2XemPercent.css";
import { Link } from "react-router-dom";

class AmUnder2XemPercent extends Component {
  state = {
    sorted: []
  };
      ...
      <div className="tableContainer">  
        <table className="table table-striped table-hover table-bordered">
          <thead>
            <tr>
              ...
              <th className="esNumColumn">Actual ≤ 2x Expected Move</th>
            </tr>
          </thead>
          <tbody>
        {this.state.sorted.map((row, i) => (            
            <tr key={i}>
              ...
              <td>{this.state.sorted[i].amUnder2XemPercent}%</td>
            </tr>  
            ))}                                                                   
          </tbody>
        </table><br/>
...
export default AmUnder2XemPercent;