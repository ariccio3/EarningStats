...
import "./amUnder175XemPercent.css";
import { Link } from "react-router-dom";

class AmUnder175XemPercent extends Component {
  state = {
    sorted: []
  };
      ...
      <div className="tableContainer">  
        ...
        {this.state.sorted.map((row, i) => (            
            <tr key={i}>
              ...
              <td>{this.state.sorted[i].amUnder175XemPercent}%</td>
            </tr>  
            ))}                                                                   
          </tbody>
        </table><br/>
...
export default AmUnder175XemPercent;